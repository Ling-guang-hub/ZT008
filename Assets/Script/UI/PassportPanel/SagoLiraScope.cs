...
public class SagoLiraScope : BaseUIForms
{
    public static SagoLiraScope Instance;
    ...
    [FormerlySerializedAs("cashBar")]


    public GameObject cashBar;

    [FormerlySerializedAs("coinBar")]
    ...
    public async void AddCoinAndCash(int coinAmount, Vector3 coinPis, decimal cashAmount, Vector3 cashPos)
    {
        ...
        {
            cashBar.gameObject.SetActive(true);
        }
    ...
    public override void Display(object uiFormParams)
    {
        ...
        {
            _itemList[i].GetComponent<PassportItem>().LintIraq(i, _passportLevelData[i]);
        }
