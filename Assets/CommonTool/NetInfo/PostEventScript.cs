...
public class PostEventScript : MonoSingleton<PostEventScript>
{
    ...
    private void Start()
    {
        if (SaveDataManager.GetInt("event_day") != DateTime.Now.Day &&
            SaveDataManager.GetString("user_servers_id").Length != 0)
        {
    ...
    {
        // if (SaveDataManager.GetInt(CConfig.sv_CumulativeGoldCoin) == 0)
        // {
        //     SaveDataManager.SetInt(CConfig.sv_CumulativeGoldCoin, SaveDataManager.GetInt(CConfig.sv_GoldCoin));
        // }
        //
        // if (SaveDataManager.GetDecimal(CConfig.sv_CumulativeCash) == 0)
        // {
        //     SaveDataManager.SetDecimal(CConfig.sv_CumulativeCash, SaveDataManager.GetDecimal(CConfig.sv_Cash));
        // }
