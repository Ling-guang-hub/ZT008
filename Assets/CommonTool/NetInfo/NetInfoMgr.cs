...
public class NetInfoMgr : MonoBehaviour
{
    ...
    [HideInInspector] public string gaid;
    [HideInInspector] public string aid;
    [HideInInspector] public string idfa;
    ...
    public void Login()
    {
        ...
        if (localId == "" || localId.Length == 0)
        {
            ...
            string timeStr = Convert.ToInt64(st.TotalSeconds).ToString() + UnityEngine.Random.Range(0, 10).ToString() +
                             UnityEngine.Random.Range(1, 10).ToString() + UnityEngine.Random.Range(1, 10).ToString() +
                             UnityEngine.Random.Range(1, 10).ToString();
            localId = timeStr;
        ...
        {
            url = LoginUrl + "&" + "randomKey" + "=" + localId + "&gaid=" + gaid + "&androidId=" + aid +
    ...
    public void SendAdjustAdid()
    {
        ...
        NetWorkManager.GetInstance().HttpGet(url,
            (data) => { Debug.Log("服务器更新adjust adid 成功" + data.downloadHandler.text); },
